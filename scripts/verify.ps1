...
$required += @('Templates\需求主页.md','Templates\案例复盘.md','Templates\快速记录.md','Templates\文档学习笔记.md','Vault\.obsidian\appearance.json','Vault\.obsidian\snippets\work-knowledge-vault.css','integrations\shared\work-knowledge\references\interaction.md','scripts\sync-agent-interaction.py')
